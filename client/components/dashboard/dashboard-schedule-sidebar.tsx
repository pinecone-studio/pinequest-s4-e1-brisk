...
export function DashboardScheduleSidebar() {
  return (
    <GoogleAgendaProvider>
      <aside className="relative z-20 hidden h-full w-80 shrink-0 flex-col gap-6 overflow-visible border-l border-zinc-200 bg-transparent p-6 dark:border-zinc-800 xl:flex">
        <CalendarWidget />
