...
export const notifications: NotificationItem[] = [
  {
    id: "notif-standup-4",
    title: "Standup summary бэлэн боллоо",
    description: "4-р өдрийн Queue + pitch standup-ийн AI хураангуй харахад бэлэн.",
    timestamp: "10 мин өмнө",
    read: false,
    type: "meeting",
  },
  {
    id: "notif-standup-3",
    title: "Gemini summary action item нэмэгдлээ",
    description: "3-р өдрийн standup-оос 3 шинэ action item Saraa-д хуваарилагдлаа.",
  ...
  {
    id: "notif-standup-2",
    title: "Chimege транскрипц дууслаа",
    description: "2-р өдрийн standup-ийн монгол transcript бэлэн боллоо.",
  ...
  {
    id: "notif-standup-1",
    title: "Анхны Brisk standup бичигдлээ",
    description: "LiveKit + D1 standup-ийн аудио амжилттай хадгалагдсан.",
    timestamp: "Өчигдөр",
    read: true,
    type: "team",
  },
